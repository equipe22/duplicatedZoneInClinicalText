...
class WordFingerprintBuilder:
    ...
    fingerprint id is generated by hashing the chunk of text (we could avoid the
    hashing and directly use the fingerprint text, but the hashing saves memory,
    because in python string slices are copied in memory).
    ...
    def __init__(
        ...
        fingerprintLength: int
            ...
            characters between the words of a fingerprint will also be included
            in the chunk. Must be at least 2 otherwise there would be gaps
