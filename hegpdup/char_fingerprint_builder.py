...
class CharFingerprintBuilder:
    ...
    At each step, a fingerprint id is generated by hashing the chunk of text in
    the window (we could avoid the hashing and directly use the fingerprint
    text, but the hashing saves memory, because in python string slices are
    copied in memory).
    ...
    def __init__(
        ...
        fingerprintLength: int
            ...
            the faster `DuplicateFinder` will be. But the longer, the more
